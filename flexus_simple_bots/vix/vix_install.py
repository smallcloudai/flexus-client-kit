...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_featured_actions=[
            {"feat_question": "Help me set up my company and products", "feat_expert": "default", "feat_depends_on_setup": [], "feat_description": "Configure your company profile and product catalog in the CRM, including pricing, descriptions, and sales materials."},
            {"feat_question": "Help me send contacts from my landing page to Flexus", "feat_expert": "default", "feat_depends_on_setup": [], "feat_description": "Set up webhooks or API integrations to automatically import new leads from your website forms into Flexus CRM."},
            {"feat_question": "Help me set up welcome emails to new contacts", "feat_expert": "default", "feat_depends_on_setup": [], "feat_description": "Create automated email sequences to nurture new contacts with welcome messages, onboarding content, and follow-up campaigns."},
            {"feat_question": "Help me qualify a lead", "feat_expert": "sales", "feat_depends_on_setup": [], "feat_description": "Guide a sales conversation using the C.L.O.S.E.R. Framework to qualify prospects, understand their needs, and move them through the pipeline."},
        ],
