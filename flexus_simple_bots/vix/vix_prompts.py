...
erp_table_data(table_name="crm_deal", options={{
    "filters": {{"AND": [
        ...
        # if policy has pipeline_ids: "deal_pipeline_id:IN:id1,id2"
        # "deal_stage_id:NOT_IN:won_id,lost_id,skip_ids..." — or if actionable stage_ids are known: "deal_stage_id:IN:stage1,stage2"
    ]}},
    "include": ["contact"],
}})
```
