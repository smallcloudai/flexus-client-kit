...
EXECUTOR_SKILLS = ckit_skills.static_skills_find(EXECUTOR_ROOTDIR, shared_skills_allowlist="")
...
EXPERTS = [
    ("default", ckit_bot_install.FMarketplaceExpertInput(
        ...
        fexp_block_tools="",
        fexp_allow_tools="",
        fexp_description="GTM Execution operator — ad campaigns, creative generation, paid tests, pilot delivery, partner ecosystem, retention and churn analysis.",
...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_title2="GTM Execution — ads, creatives, pilots, partners, retention",
        marketable_author="Flexus",
        marketable_occupation="GTM Execution Operator",
        marketable_description=(
            "Consolidates ad campaign execution, creative generation, paid channel tests, "
        ...
        marketable_featured_actions=[
            ...
            {"feat_question": "Generate ad creatives with brand style guide", "feat_expert": "default", "feat_depends_on_setup": []},
        ...
        marketable_intro_message="I'm Executor. Load a skill to activate a workflow: admonster, botticelli, creative-paid-channels, pilot-delivery, partner-ecosystem, retention-intelligence, or churn-learning.",
