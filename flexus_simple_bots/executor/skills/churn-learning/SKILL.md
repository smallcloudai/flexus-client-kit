...
After completing interviews, call `write_churn_interview_corpus(path=/churn/interviews/corpus-{YYYY-MM-DD}, data={...})`:
...
After assessing interview coverage, call `write_churn_interview_coverage(path=/churn/interviews/coverage-{YYYY-MM-DD}, data={...})`:
- path: `/churn/interviews/coverage-{YYYY-MM-DD}`

## Recording Signal Quality

After running quality checks, call `write_churn_signal_quality(path=/churn/quality/signal-{YYYY-MM-DD}, data={...})`:
...
After classifying root causes, call `write_churn_rootcause_backlog(path=/churn/rootcause/backlog-{YYYY-MM-DD}, data={...})`:
...
After designing experiments, call `write_churn_fix_experiment_plan(path=/churn/experiments/plan-{YYYY-MM-DD}, data={...})`:
...
After completing priority review, call `write_churn_prevention_priority_gate(path=/churn/gate/priority-{YYYY-MM-DD}, data={...})`:
...
```json
{
  "write_churn_fix_experiment_plan": {
    "type": "object"
  },
  "write_churn_interview_corpus": {
    "type": "object"
  },
  "write_churn_interview_coverage": {
    "type": "object"
  },
  "write_churn_prevention_priority_gate": {
    "type": "object"
  },
  "write_churn_rootcause_backlog": {
    "type": "object"
  },
  "write_churn_signal_quality": {
    "type": "object"
  }
}
```
