...
Output data: /marketing-experiments/{experiment_id}/tactics-campaigns
             /marketing-experiments/{experiment_id}/tactics-creatives
             /marketing-experiments/{experiment_id}/tactics-landing
             /marketing-experiments/{experiment_id}/tactics-tracking
"""
...
if msg["role"] == "assistant":
    ...
    # Collect all document paths from tool results (created ✍️ or read 📄)
    tactics_docs_found = []
        ...
        if m.get("role") == "tool":
            ...
            for line in tc.split("\\n"):
                for suffix in tactics_suffixes:
                    if suffix in line and (line.startswith("✍️") or line.startswith("📄")):
...
```
flexus_policy_document(op="list", args={"p": "/marketing-experiments/{experiment_id}/"})
```
...
Path: `/marketing-experiments/{experiment_id}/tactics-campaigns`
...
Path: `/marketing-experiments/{experiment_id}/tactics-creatives`
...
Path: `/marketing-experiments/{experiment_id}/tactics-landing`
...
Path: `/marketing-experiments/{experiment_id}/tactics-tracking`
