...
Use `linkedin_b2b.organization_posts.list.v1` to understand what topics the organization publicly discusses — this reveals what the leadership team cares about.
