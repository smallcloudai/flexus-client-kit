...
```json
{
  "interview_schedule": {
    "type": "object",
    "required": ["study_id", "sessions", "coverage_status"],
    ...
    "properties": {
      ...
      "sessions": {
        ...
        "items": {
          "type": "object",
          "required": ["session_id", "participant_id", "scheduled_at", "status"],
          "additionalProperties": false,
          "properties": {
            ...
            "status": {"type": "string", "enum": ["scheduled", "completed", "no_show", "cancelled", "rescheduled"]},
            "notes": {"type": "string"}
          }
        }
      },
