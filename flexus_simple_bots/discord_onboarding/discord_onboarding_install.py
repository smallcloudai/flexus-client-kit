...
from flexus_simple_bots.discord_onboarding import discord_onboarding_prompts
from flexus_simple_bots.version_common import SIMPLE_BOTS_COMMON_VERSION


ROOT = Path(__file__).parent

DISCORD_ONBOARDING_SETUP_SCHEMA = json.loads((ROOT / "setup_schema.json").read_text())

EXPERTS = [
    (
        "default",
        ckit_bot_install.FMarketplaceExpertInput(
            fexp_system_prompt=discord_onboarding_prompts.discord_onboarding_stub,
            fexp_python_kernel="",
            fexp_block_tools="",
            fexp_allow_tools="",
...
async def install(
    ...
    pic_big_b64 = base64.b64encode((ROOT / "discord_onboarding-1024x1536.webp").read_bytes()).decode("ascii")
    pic_small_b64 = base64.b64encode((ROOT / "discord_onboarding-256x256.webp").read_bytes()).decode("ascii")
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_title1="Discord Onboarding",
        ...
        marketable_run_this="python -m flexus_simple_bots.discord_onboarding.discord_onboarding_bot",
        marketable_setup_default=DISCORD_ONBOARDING_SETUP_SCHEMA,
        ...
        marketable_tags=["Discord", "Community", "Onboarding"],
...
if __name__ == "__main__":
    async def _main() -> None:
        fclient = ckit_client.FlexusClient(ckit_client.bot_service_name("discord_onboarding", SIMPLE_BOTS_COMMON_VERSION), endpoint="/v1/jailed-bot")
        await install(fclient, "discord_onboarding", SIMPLE_BOTS_COMMON_VERSION, [])
