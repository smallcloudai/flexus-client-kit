...
_PIC_BIG_B64 = base64.b64encode((Path(__file__).parent / "pilot_delivery_bot-1024x1536.webp").read_bytes()).decode("ascii")
_PIC_SMALL_B64 = base64.b64encode((Path(__file__).parent / "pilot_delivery_bot-256x256.webp").read_bytes()).decode("ascii")
