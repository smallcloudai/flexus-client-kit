...
from flexus_client_kit.core import ckit_bot_install, ckit_client, ckit_cloudtool
from flexus_simple_bots.shared import prompts_common
from flexus_simple_bots.handcrafted.telegram_groupmod import telegram_groupmod_bot, telegram_groupmod_prompts
...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_run_this="python -m flexus_simple_bots.handcrafted.telegram_groupmod.telegram_groupmod_bot",
