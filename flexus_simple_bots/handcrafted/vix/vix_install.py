...
from flexus_client_kit.integrations.providers.internal_automations import fi_crm_automations
from flexus_client_kit.integrations.providers.inbound_webhooks import fi_resend
from flexus_client_kit.integrations.providers.inbound_webhooks import fi_shopify

from flexus_simple_bots.shared import prompts_common
from flexus_simple_bots.handcrafted.vix import vix_bot, vix_prompts
...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_run_this="python -m flexus_simple_bots.handcrafted.vix.vix_bot",
