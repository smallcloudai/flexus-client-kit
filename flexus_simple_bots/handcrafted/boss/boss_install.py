...
from flexus_simple_bots.handcrafted.boss import boss_prompts
...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_run_this="python -m flexus_simple_bots.handcrafted.boss.boss_bot",
...
if __name__ == "__main__":
    from flexus_simple_bots.handcrafted.boss import boss_bot
