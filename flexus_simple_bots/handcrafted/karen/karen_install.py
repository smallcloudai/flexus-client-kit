...
from flexus_client_kit.integrations.providers.request_response import fi_discord2

from flexus_simple_bots.shared import prompts_common
from flexus_simple_bots.handcrafted.karen import karen_prompts
...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_run_this="python -m flexus_simple_bots.handcrafted.karen.karen_bot",
...
if __name__ == "__main__":
    from flexus_simple_bots.handcrafted.karen import karen_bot
