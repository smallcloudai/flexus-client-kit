...
from flexus_client_kit.core import ckit_client, ckit_bot_install
from flexus_client_kit.core import ckit_cloudtool

from flexus_simple_bots.shared import prompts_common
from flexus_simple_bots.handcrafted.productman import productman_bot, productman_prompts, productman_skill_survey
...
async def install(
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_run_this="python -m flexus_simple_bots.handcrafted.productman.productman_bot",
