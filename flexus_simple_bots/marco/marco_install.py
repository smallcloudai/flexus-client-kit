...
from flexus_simple_bots.marco import marco_bot
from flexus_simple_bots.marco import marco_prompts
...
MARCO_DESC = (marco_bot.MARCO_ROOTDIR / "README.md").read_text()
...
EXPERTS = [
    ("default", ckit_bot_install.FMarketplaceExpertInput(
        fexp_system_prompt=marco_prompts.MARCO_DEFAULT,
        fexp_python_kernel="",
        ...
        fexp_builtin_skills=ckit_skills.read_name_description(marco_bot.MARCO_ROOTDIR, [
    ...
    ("messages_triage", ckit_bot_install.FMarketplaceExpertInput(
        fexp_system_prompt=marco_prompts.MARCO_TRIAGE,
        fexp_python_kernel="",
    ...
    ("very_limited", ckit_bot_install.FMarketplaceExpertInput(
        fexp_system_prompt=marco_prompts.MARCO_VERY_LIMITED,
        fexp_python_kernel=MARCO_KERNEL,
        fexp_allow_tools=",".join(TOOLS_MARCO),
    ...
    ("post_conversation", ckit_bot_install.FMarketplaceExpertInput(
        fexp_system_prompt=marco_prompts.MARCO_POST_CONVERSATION,
        fexp_python_kernel="",
    ...
    ("nurturing", ckit_bot_install.FMarketplaceExpertInput(
        fexp_system_prompt=marco_prompts.MARCO_NURTURING,
        fexp_python_kernel="",
...
async def install(client: ckit_client.FlexusClient):
    r = await ckit_bot_install.marketplace_upsert_dev_bot(
        client,
        ws_id=client.ws_id,
        bot_dir=marco_bot.MARCO_ROOTDIR,
        marketable_accent_color="#2563EB",
        marketable_title1="Marco",
        ...
        marketable_description=MARCO_DESC,
        marketable_typical_group="Sales",
        marketable_setup_default=marco_bot.MARCO_SETUP_SCHEMA,
        ...
        marketable_intro_message="Hi! I'm Marco. I qualify leads, handle objections, manage your CRM pipeline, and run follow-up automations. What would you like to work on?",
        ...
        marketable_experts=[(name, exp.filter_tools(marco_bot.TOOLS)) for name, exp in EXPERTS],
        ...
        add_integrations_into_expert_system_prompt=marco_bot.MARCO_INTEGRATIONS,
    )
    return r.marketable_version


if __name__ == "__main__":
    client = ckit_client.FlexusClient("marco_install")
