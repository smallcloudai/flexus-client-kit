        ...
        await my_prisma.flexus_persona.upsert(
            ...
            data={
                "create": {
                    ...
                    "persona_preferred_model_expensive": marketplace_rec.marketable_preferred_model_expensive,
                    "persona_preferred_model_cheap": marketplace_rec.marketable_preferred_model_cheap,
