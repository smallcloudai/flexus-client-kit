...
async def install_from_manifest(m, setup_schema, bot_dir, client, bot_name, bot_version, tools):
    ...
    await ckit_bot_install.marketplace_upsert_dev_bot(
        ...
        marketable_preferred_model_expensive=m.get("preferred_model_expensive", m.get("preferred_model_default", "")),
        marketable_preferred_model_cheap=m.get("preferred_model_cheap", m.get("preferred_model_default", "")),
