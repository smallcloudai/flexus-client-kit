...
# ---------------------------------------------------------------------------
# Shared Discord helpers (no discord.py): used by gateway-only discord_bot and
# fi_discord2 so snowflake/setup/auth/logging stay one place (architecture: thin
# connector surface, heavy integration defers to these).
# ---------------------------------------------------------------------------
