...
No discord.py: ``DISCORD_TRIGGERS``, ``DISCORD_ACTIONS``, and ``discord_automation_semantics_bundle()``
feed schema assembly and reviewer payloads. Shared Discord runtime helpers stay in ``ckit_connector_discord``.
"""
...
from flexus_client_kit.ckit_automation_catalog import (
    ActionDescriptor,
    SemanticContract,
    TriggerDescriptor,
