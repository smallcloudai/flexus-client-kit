...
from flexus_client_kit.integrations.providers.request_response.facebook.utils import format_currency, format_account_status, validate_ad_account_id
...
async def list_ad_accounts(client: "FacebookAdsClient") -> str:
    ...
    data = await client.request("GET", "me/adaccounts", params={"fields": AD_ACCOUNT_FIELDS, "limit": 50})
...
async def get_ad_account_info(client: "FacebookAdsClient", ad_account_id: str) -> str:
    ...
    acc = await client.request("GET", ad_account_id, params={"fields": AD_ACCOUNT_DETAIL_FIELDS})
