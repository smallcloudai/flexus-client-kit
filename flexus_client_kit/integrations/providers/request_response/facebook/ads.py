...
import httpx
from flexus_client_kit.integrations.providers.request_response.facebook.models import AdFormat, CallToActionType
from flexus_client_kit.integrations.providers.request_response.facebook.utils import validate_ad_account_id
from flexus_client_kit.integrations.providers.request_response.facebook.exceptions import FacebookValidationError
if TYPE_CHECKING:
...
"""
    ...
    if image_url:
        ...
        with open(image_file, 'rb') as f:
            image_bytes = f.read()
        from flexus_client_kit.integrations.providers.request_response.facebook.client import API_BASE, API_VERSION
