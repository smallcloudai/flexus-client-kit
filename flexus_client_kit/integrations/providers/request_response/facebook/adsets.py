...
from flexus_client_kit.integrations.providers.request_response.facebook.utils import format_currency, validate_budget, validate_targeting_spec
...
async def list_adsets(client: "FacebookAdsClient", campaign_id: str) -> str:
    ...
    data = await client.request("GET", f"{campaign_id}/adsets", params={"fields": ADSET_FIELDS, "limit": 50})
...
"""
    ...
    result = await client.request(
        "GET", f"{account_id}/targetingsentencelines",
